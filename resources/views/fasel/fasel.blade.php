        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#exampleModal">تسجيل طالب</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-ptrainer_id-length='50'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$x->price}}</td>
                                    <td>{{$x->ClassCourses->price -$x->price }}</td>
                                    <td>

                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-id="{{ $x->id }}" data-classcourses_id="{{ $x->classcourses_id }}" data-student_id="{{ $x->student_id }}" data-price="{{ $x->price }}" data-toggle="modal" href="#exampleModal2" title="تعديل"><i class="las la-pen"></i>
                                        </a>

                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-toggle="modal" href="#modaldemo9" title="حذف"><i class="las la-trash"></i>
                                        </a>
                ...
                <form action="{{route('fasel.store')}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <select name="student_id" id="student_id" class="form-control" required>
                            ...
                            <option value="{{ $Students->id }}">{{ $Students->firestname.' '.$Students->fullname }}</option>
                            @endforeach
                        </select>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">قيمة المدفوعة</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/fasel/update" method="post" autocomplete="off">
                        {{method_field('patch')}}
                        {{csrf_field()}}
                        <div class="form-group">
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف </h6><button aria-label="Close" class="close" data-dismiss="modal" 9+6 type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="fasel/destroy" method="post">
                    {{method_field('delete')}}
                    {{csrf_field()}}
                    <div class="modal-body">
